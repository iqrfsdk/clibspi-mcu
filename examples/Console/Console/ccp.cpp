...
void ccpLsCmd (uint16_t CommandParameter){
  ...
  iqrfSuspendDriver();                                                     // suspend SPI comunication with TR module
  ...
  iqrfRunDriver();                                                          // start SPI comunication with TR modul
}
...
void ccpTestCmd (uint16_t CommandParameter)
{
    switch(CommandParameter){
        ...
        case 1: iqrfTrEnterPgmMode();
        break;

        case 2: iqrfTrPowerOff();
        break;

        case 3: iqrfTrPowerOn();
        break;
    }
}
